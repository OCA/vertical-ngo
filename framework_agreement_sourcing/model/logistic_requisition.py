...
class logistic_requisition_line(orm.Model):
    ...
    def _generate_lines_from_agreements(self, cr, uid, container, line,
        ...
        source_id = self.make_source_line(
            cr, uid,
            line,
            force_qty=to_consume,
        ...
        if difference:
            return self._generate_lines_from_agreements(
                cr,
                uid,
                container,
                line,
    ...
    def _source_lines_for_agreements(self, cr, uid, line, agreements,
        ...
        generated = []
        remaining_qty = self._generate_lines_from_agreements(
            cr,
            uid,
            generated,
            line,
    ...
    def make_source_line(self, cr, uid, line,
                         force_qty=None, agreement=None, context=None):
        ...
        vals = self._prepare_line_source(cr, uid,
                                         line,
                                         qty=qty,
                                         agreement=agreement,
                                         context=None)
    ...
    def _generate_source_line(self, cr, uid, line, context=None):
        ...
        running we generate one or n source line using agreements
        ...
        agreements = agr_obj.get_all_product_agreements(
            cr,
            uid,
            product_id,
            date,
        ...
        if agreements:
            ...
            if missing_qty:
                generated_lines.append(
                    self.make_source_line(cr, uid, line, force_qty=missing_qty)
                )
        else:
